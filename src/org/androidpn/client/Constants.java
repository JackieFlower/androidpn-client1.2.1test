...
public class Constants {
    ...
    public static final String NOTIFICATION_SOURCE_NAME = "NOTIFICATION_SOURCE_NAME";
    
    //add on 0514
    public static final String NOTIFICATION_CONFIGURATION = "NOTIFICATION_CONFIGURATION";
    public static final String NOTIFICATION_DEVICEID = "NOTIFICATION_DEVICEID";
    public static final String NOTIFICATION_RESOURCES_LIST = "NOTIFICATION_RESOURCES_LIST";
    ...
    public static final String ACTION_NOTIFICATION_INSTALLED = "org.androidpn.client.NOTIFICATION_INISTALLED";
